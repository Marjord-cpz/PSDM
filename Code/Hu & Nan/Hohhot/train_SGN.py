...
student1_model=architecture.Student1().cuda()
...
optimizer1=optim.Adam(student1_model.parameters(),lr=learning_rate,weight_decay=0.0005)
optimizer2=optim.Adam(student2_model.parameters(),lr=learning_rate,weight_decay=0.0005)
