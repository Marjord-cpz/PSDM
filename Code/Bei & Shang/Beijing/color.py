...
def verify_second_ms(model, label_loader, unlabel_loader, expo, num, mode='2'):
    ...
    # picture.show()
    savepath = "Result\Beijing" + expo + str(num) + "_picms_1.png"
    ...
    # picture.show()
    savepath = "Result\Beijing" + expo + str(num) + "_picms_2.png"
...
def verify_second_pan(model, label_loader, unlabel_loader, expo, num, mode='2'):
    ...
    picture1 = Image.fromarray(np.uint8(label_pic))
    # picture.show()
    savepath ="Result\Beijing" + expo + str(num) + "_pic_1pan.png"
    picture1.save(savepath)
    ...
    picture2 = Image.fromarray(np.uint8(label_pic))
    # picture.show()
    savepath = "Result\Beijing" + expo + str(num) + "_picpan_2.png"
    picture2.save(savepath)
...
if __name__=='__main__':
    ...
    verify_second_ms(studentms,label_loader,unlabel_loader,"image9",1)
    verify_second_ms(studentms,label_loader,unlabel_loader,"image9",1)