...
EPOCH=10
# loading data
train_data,test_data,all_data,train_loader,test_loader,all_data_loader=getDataset()
# loading model
...
# save model
if os.path.exists(".\pre trained models\teacher.pkl")==0:
    torch.save(teacher,".\pre trained models\teacher.pkl")
else:
    pass
